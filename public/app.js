...
const translations = {
  en: {
    ...
    totalWithoutRent: 'Total without rent',
    rentAmount: 'Rent amount',
    grandTotalIncludingRent: 'Grand total including rent',
  ...
  vi: {
    ...
    monthlyBills: 'Hoa don nha hang thang',
    editBill: 'Sua hoa don',
    billItem: 'Muc',
    billItemRequired: 'Vui long nhap muc',
    amount: 'So tien',
    invalidBillAmount: 'So tien khong hop le',
    dueDate: 'Ngay den han',
    payBefore: 'Thanh toan truoc',
    totalWithoutRent: 'Tong khong gom tien nha',
    rentAmount: 'Tien nha',
    grandTotalIncludingRent: 'Tong cong gom tien nha',
    mortgageLink: 'Tien nha',
    electricLink: 'Dien',
    waterLink: 'Nuoc',
    gasLink: 'Gas',
    internetLink: 'Internet',
    phoneLink: 'Dien thoai',
    cardName: 'So the',
    cardNamePlaceholder: 'So the hoac biet danh',
    creditCardUser: 'Nguoi dung',
    creditCardUserPlaceholder: 'Chu the',
    creditCardIssuer: 'Loai the',
    creditCardIssuerPlaceholder: 'Chon loai the',
    totalBalance: 'So du',
    invalidCreditCardIssuer: 'Loai the khong hop le',
    closingDate: 'Ngay chot sao ke',
    addCard: 'Them the',
    noCreditCards: 'Chua co the tin dung.',
    creditCardAdded: 'Da them the tin dung.',
    creditCardUpdated: 'Da cap nhat the tin dung.',
    editCreditCard: 'Sua the',
    closingDateSaved: 'Da luu ngay chot sao ke.',
    creditCardNameRequired: 'Vui long nhap so the',
    invalidCreditCardBalance: 'So du khong hop le',
