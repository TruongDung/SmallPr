(function () {
  const getElements = () => ({
    ...
    fastAccessLinksList: document.getElementById('credit-card-link-list'),
    openAddFastAccessLinkButton: document.getElementById('open-add-fast-access-link'),
    addFastAccessLinkModal: document.getElementById('add-fast-access-link-modal'),
    addFastAccessLinkForm: document.getElementById('add-fast-access-link-form'),
    fastAccessLinkLabelInput: document.getElementById('fast-access-link-label'),
    fastAccessLinkUrlInput: document.getElementById('fast-access-link-url'),
    addFastAccessLinkError: document.getElementById('add-fast-access-link-error'),
    cancelAddFastAccessLinkButton: document.getElementById('cancel-add-fast-access-link'),
    saveAddFastAccessLinkButton: document.getElementById('save-add-fast-access-link'),
