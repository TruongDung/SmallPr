(function () {
  ...
  en: {
    ...
    noteHistory: 'History',
    noteHistoryBodyChanged: 'Body',
    noteHistoryChangedFields: 'Different from current note',
    noteHistoryDiffHint: 'Green lines are current text. Red lines are text from this past version.',
    noteHistoryEmpty: 'No previous versions yet.',
    noteHistoryNoChanges: 'Same as current note',
    noteHistoryNow: 'Now',
    noteHistoryWas: 'Was',
  ...
  vi: {
    ...
    noteHistory: 'Lịch sử',
    noteHistoryBodyChanged: 'Nội dung',
    noteHistoryChangedFields: 'Khác với ghi chú hiện tại',
    noteHistoryDiffHint: 'Dòng xanh là nội dung hiện tại. Dòng đỏ là nội dung ở phiên bản cũ này.',
    noteHistoryEmpty: 'Chưa có phiên bản trước.',
    noteHistoryNoChanges: 'Giống ghi chú hiện tại',
    noteHistoryNow: 'Hiện tại',
    noteHistoryWas: 'Trước đó',
    previousPage: 'Trước',
    nextPage: 'Tiếp',
