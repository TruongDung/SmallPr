export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    relatedTasksHint: 'Select one or more related tasks.',
    ...
    calendar: 'Calendar',
    settings: 'Settings',
    lunarReminderSettings: 'Lunar Calendar Reminders',
    enableLunarReminders: 'Enable Lunar Calendar Reminders',
    reminderDaysBefore: 'Reminder Days Before',
    importantDates: 'Important Dates',
    lunarDay1: 'Lunar Day 1 (Mùng 1)',
    lunarDay15: 'Lunar Day 15 (Ngày Rằm)',
    showLunarDatesInCalendar: 'Show Lunar Dates in Calendar',
    lunarReminderDateRequired: 'Select at least one lunar date to remind before.',
  ...
  vi: {
    ...
    relatedTasksHint: 'Chọn một hoặc nhiều công việc liên quan.',
    ...
    calendar: 'Lịch',
    settings: 'Cài đặt',
    lunarReminderSettings: 'Nhắc lịch âm',
    enableLunarReminders: 'Bật nhắc lịch âm',
    reminderDaysBefore: 'Nhắc trước số ngày',
    importantDates: 'Ngày quan trọng',
    lunarDay1: 'Mùng 1',
    lunarDay15: 'Ngày Rằm',
    showLunarDatesInCalendar: 'Hiện ngày âm trong lịch',
    lunarReminderDateRequired: 'Vui lòng chọn ít nhất một ngày âm để nhắc.',
    timezoneInvalid: 'Múi giờ không hợp lệ.',
    sprints: 'Sprint',
