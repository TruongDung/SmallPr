...
export const taskStatus = (task: Task): TaskStatus => (task.status as TaskStatus) || (task.completed ? 'done' : 'todo');

export const priorityLabel = (t: TranslateFn, priority: string = 'medium') => t(priority || 'medium');
